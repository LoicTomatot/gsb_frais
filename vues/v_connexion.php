...
<form method="POST" action="index.php?uc=connexion&action=valideConnexion">
       ...
       <input id="login" type="text" name="login" placeholder="Saisir un nom d'utilisateur" size="30" maxlength="45" value=<?php if(isset($_SESSION['login'])) { print($_SESSION['login']);}?>>
      </p>
			<p>
				<label id="leslabels" for="mdp">Mot de passe :</label><br />
			  <input id="mdp"  type="password" placeholder="Saisir un mot de passe" name="mdp" size="30" maxlength="45" value=<?php if(isset($_SESSION['mdp'])) { print($_SESSION['mdp']);}?>>
      </p>
