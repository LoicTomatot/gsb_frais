...
<form method="POST" action="index.php?uc=connexion&action=valideConnexion">
      ...
      <input type="checkbox" name="souvenir" id="cochersouvenir" <?php if(isset($_SESSION['checked'])) {print($_SESSION['checked']);}?>/><label for="souvenir">Se souvenir de moi</label><br />
